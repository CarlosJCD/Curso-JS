 ...
 * @returns {Imagen[]}
 */
export async function buscarImagenesDelTerminoDeBusqueda(terminoDeBusqueda, paginaActual = 1) {
    const respuestaAPI = await fetch(obtenerAPIURLConTerminoDeBusqueda(terminoDeBusqueda, paginaActual));
